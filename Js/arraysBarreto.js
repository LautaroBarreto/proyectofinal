...
let ordenSostenidos = new Escalas("FA#, DO#, SOL#, RE#, LA#, MI#, SI#", 'No posee', 'sostenidos');
let ordenBemoles = new Escalas("SIb, MIb, LAb, REb, SOLb, DOb, FAb", 'No posee', 'bemoles');

//escalas mayores con sostenido
//reemplazada con array asociativo

let escalaDo = new Escalas("DO, RE, MI, FA, SOL, LA, SI", 'mayor', 'No posee alteraciones');
...
let escalaLaMenor = new Escalas("LA, SI, DO, RE, MI, FA, SOL", "menor", "No posee alteraciones");
